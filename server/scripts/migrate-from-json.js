...
async function migrateAllData() {
  try {
    console.log('🚀 Iniciant migració de dades des de JSON...');
    
    // Conectar a MongoDB con configuración más robusta
    ...
    const uri = process.env.MONGODB_URI || "mongodb+srv://test:U1SHxjVdRiDCxkpH@cluster0.kx7ne.mongodb.net/newLletresBarbares?retryWrites=true&w=majority&appName=Cluster0";
    
    console.log('🔌 Conectant a MongoDB Atlas...');
    ...
    // Obtener años disponibles - corregir ruta
