  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Resumen de Conexiones (Opcional) */}
        {(stats as any)?.connectionSummary && (
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mt-8">
            <h3 className="text-lg font-semibold text-blue-900 mb-2">📊 Resum de Connexions</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              <div>
                <span className="text-blue-700 font-medium">Total Connexions:</span>
                <span className="ml-2 text-blue-900">{formatNumber((stats as any).connectionSummary.totalConnections)}</span>
              </div>
              <div>
                <span className="text-blue-700 font-medium">IPs Úniques:</span>
                <span className="ml-2 text-blue-900">{formatNumber((stats as any).connectionSummary.uniqueIPs)}</span>
              </div>
              <div>
                <a 
                  href="/admin-connections-2024" 
                ...
                >
                  → Veure analytics completes de connexions
                </a>
              </div>
            </div>
          </div>
